    ...
    <>
      ...
      <div className="dk-container pt-4">
        ...
        <div className="dk-card p-8 mb-6 text-center animate-fade-in">
          <h1 className="text-3xl font-bold mb-4" style={{ color: 'var(--dk-primary)' }}>درباره اطلس شاپ</h1>
        ...
        <section className="dk-card p-8 mb-6 animate-slide-up">
          <h2 className="text-xl font-bold mb-6 flex items-center gap-2">
            <span className="w-1 h-6 rounded-full inline-block" style={{ background: 'var(--dk-primary)' }} />
            چرا اطلس شاپ؟
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center">
              <div className="w-16 h-16 rounded-2xl mx-auto mb-4 flex items-center justify-center text-3xl" style={{ background: 'var(--dk-bg)' }}>✓</div>
              <h3 className="font-bold mb-2">ضمانت اصالت کالا</h3>
              <p className="text-sm text-[var(--dk-text-light)] leading-6">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ.</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 rounded-2xl mx-auto mb-4 flex items-center justify-center text-3xl" style={{ background: 'var(--dk-bg)' }}>✓</div>
        ...
        <section className="dk-card p-8 mb-6 animate-slide-up">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
            <div className="p-6 rounded-2xl" style={{ background: 'var(--dk-bg)' }}>
              <span className="text-4xl font-bold" style={{ color: 'var(--dk-primary)' }}>۱۰+</span>
              <p className="text-sm text-[var(--dk-text-light)] mt-2">سال تجربه</p>
            </div>
            <div className="p-6 rounded-2xl" style={{ background: 'var(--dk-bg)' }}>
              <span className="text-4xl font-bold" style={{ color: 'var(--dk-primary)' }}>۵۰٬۰۰۰+</span>
              <p className="text-sm text-[var(--dk-text-light)] mt-2">مشتری راضی</p>
            </div>
            <div className="p-6 rounded-2xl" style={{ background: 'var(--dk-bg)' }}>
              <span className="text-4xl font-bold" style={{ color: 'var(--dk-primary)' }}>۱۰۰٬۰۰۰+</span>
              <p className="text-sm text-[var(--dk-text-light)] mt-2">سفارش موفق</p>
            </div>
          </div>
        </section>
      </div>
