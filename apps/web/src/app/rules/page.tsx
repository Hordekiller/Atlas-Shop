    ...
    <>
      ...
      <div className="dk-container pt-4">
        <nav className="flex items-center gap-2 text-sm text-[var(--dk-text-light)] mb-6">
          ...
          <span>/</span>
          <span className="text-[var(--dk-text)] font-medium">قوانین و مقررات</span>
        </nav>

        <h1 className="text-3xl font-bold mb-6" style={{ color: 'var(--dk-primary)' }}>قوانین و مقررات</h1>
        ...
        <div className="flex flex-col lg:flex-row gap-6 mb-8">
          ...
          <div className="flex-1 space-y-6">
            {sections.map((sec, i) => (
              <section key={sec.id} id={sec.id} className="dk-card p-8 animate-slide-up">
                ...
                <p className="text-sm text-[var(--dk-text-light)] leading-7">{sec.content}</p>
              </section>
            ))}
          </div>
        </div>
