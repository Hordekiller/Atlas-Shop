  ...
  return (
    <>
      ...
      <div className="dk-container pt-4">
        ...
        <h1 className="text-3xl font-bold mb-6" style={{ color: 'var(--dk-primary)' }}>تماس با ما</h1>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          {/* Contact Info */}
          <div className="space-y-4">
            <div className="dk-card p-6 flex items-start gap-4 animate-fade-in">
              <div className="w-12 h-12 rounded-xl flex items-center justify-center text-xl shrink-0" style={{ background: 'var(--dk-bg)', color: 'var(--dk-primary)' }}>📍</div>
              <div>
                <h3 className="font-bold text-sm mb-1">آدرس</h3>
                <p className="text-sm text-[var(--dk-text-light)] leading-6">تهران، خیابان ولیعصر، کوچه گلستان، پلاک ۱۲۳، واحد ۵</p>
              </div>
            </div>
            ...
            <div className="dk-card p-6 flex items-start gap-4 animate-fade-in">
              ...
              <div>
                ...
                <p className="text-sm text-[var(--dk-text-light)]">۰۲۱-۱۲۳۴۵۶۷۸</p>
                <p className="text-sm text-[var(--dk-text-light)]">۰۹۱۲-۱۲۳۴۵۶۷</p>
              </div>
            </div>

            <div className="dk-card p-6 flex items-start gap-4 animate-fade-in">
              <div className="w-12 h-12 rounded-xl flex items-center justify-center text-xl shrink-0" style={{ background: 'var(--dk-bg)', color: 'var(--dk-primary)' }}>✉️</div>
              <div>
                <h3 className="font-bold text-sm mb-1">ایمیل</h3>
                <p className="text-sm text-[var(--dk-text-light)]">info@atlasso.ir</p>
                <p className="text-sm text-[var(--dk-text-light)]">support@atlasso.ir</p>
              </div>
            </div>
            ...
            <div className="dk-card p-6 flex items-start gap-4 animate-fade-in">
              ...
              <div>
                ...
                <p className="text-sm text-[var(--dk-text-light)]">شنبه تا چهارشنبه: ۹:۰۰ الی ۱۸:۰۰</p>
                <p className="text-sm text-[var(--dk-text-light)]">پنجشنبه: ۹:۰۰ الی ۱۴:۰۰</p>
                <p className="text-sm text-[var(--dk-text-light)]">جمعه: تعطیل</p>
              </div>
            </div>
          </div>
          ...
          <div className="dk-card p-8 animate-slide-up">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <label className="text-xs font-medium text-[var(--dk-text-light)] block mb-1">نام و نام خانوادگی</label>
                <input
                  type="text"
                  required
                  value={form.name}
              ...
              <div>
                <label className="text-xs font-medium text-[var(--dk-text-light)] block mb-1">ایمیل</label>
                <input
                  type="email"
                  required
                  value={form.email}
              ...
              <div>
                <label className="text-xs font-medium text-[var(--dk-text-light)] block mb-1">موضوع</label>
                <input
                  type="text"
                  required
                  value={form.subject}
              ...
              <div>
                <label className="text-xs font-medium text-[var(--dk-text-light)] block mb-1">پیام</label>
                <textarea
                  required
                  rows={5}
                  value={form.message}
